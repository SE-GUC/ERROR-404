...
const functions = {
  ...
  searchDebatesbydate: async () => {
    ...
    const debate = await axios.get(
      "http://localhost:3000/api/Debates/searchbydate/12-21-2001"
    );
  ...
  searchDebatesbycategory: async () => {
    ...
    const debate = await axios.get(
      "http://localhost:3000/api/Debates/Search/health"
    );
    return debate;
  },
  getFAQs: async () => {
  ...
  deleteFAQs: async id => {
    const deletedFAQ = await axios.delete(
  ...
  searchUsersByName: async () => {
    ...
    const user = await axios.get(
      "http://localhost:3000/api/Users/Search/nouran"
    );
  ...
  searchUsersByType: async () => {
    ...
    const id = newUser.data.data._id;
    const user = await axios.get(
      "http://localhost:3000/api/Users/Search/alumni"
    );
    const deletedUser = await axios.delete(
      "http://localhost:3000/api/Users/" + id
    );
  ...
  updateFAQs: async id => {
    const updatedFAQ = await axios.put(
      "http://localhost:3000/api/FAQs/edit/" + id,
      {
        //a7ot id mazboot
  ...
  searchArticlesByTitle: async id => {
    ...
    const article = await axios.get(
      "http://localhost:3000/api/Articles/Search/are/"
    ); //a7ot id mazboot
    return article;
  },
  searchMotionsByTitle: async id => {
    const newChatBar = await axios.post(
      "http://localhost:3000/api/Chatbars/create",
      {
    ...
    const chatBar = await axios.get(
      "http://localhost:3000/api/Chatbars/search/are/"
    ); //a7ot id mazboot
    return chatBar;
  },
  getQuestionsAdmin: async id => {
    const question = await axios.get(
      "http://localhost:3000/api/Questions/admin/"
    ); //a7ot id mazboot
    return question;
  },
  getQuestions: async id => {
    const question = await axios.get(
      "http://localhost:3000/api/Questions/allQuestions/admin/"
    ); //a7ot id mazboot
    return question;
  },
  deleteQuestions: async id => {
    const deletedQuestion = await axios.delete(
  ...
  answerQuestion: async id => {
    const question = await axios.put(
      "http://localhost:3000/api/Questions/answerquestion/" + id,
      {
        //a7ot id mazboot
        answer: "nouran"
      }
  ...
  getAnswers: async id => {
    const answer = await axios.get(
      "http://localhost:3000/api/Questions/user/" + id
    ); //a7ot id mazboot
    return answer;
  }
};
